...
export default class starRatingsTraining extends LightningElement {

    @api recordId
    @api labelStyle='';
    @track stars;
    @track componentClass = '';
    @track scoreSizeClass = '';
    @track color = '#999';
    @track isShowSpinner;
    ...
    set showScore(value) {
        ...
        this.scoreSizeClass = this.getScoreSizeClassNames();
    }
    ...
    getScoreSizeClassNames() {
        const classNames = ['slds-var-p-left_small'];
        if(this._showScore == 'true'){
            classNames.push('showScore');
        }else {
            classNames.push('hideScore');
        }
        classNames.push(this.scoreSize);
