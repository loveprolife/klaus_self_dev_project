...
import searchLookupData from '@salesforce/apex/Lookup.searchSalesOrgLookupData';
import searchDefaultRecord from '@salesforce/apex/Lookup.searchDefaultRecord';

export default class SubUserLookUp extends LightningElement {
    // public properties with initial default values 
    // @api label = 'label';
    @api placeholder = 'search...';
    @api iconName = 'standard:user';
    @api sObjectApiName = 'SubUser__c';
    @api defaultRecordId = 'a5uA80000000BxxIAE';
    @api required;
    @api reaonly;
    @api requiredClass;
    @api label = 'Person:';
    ...
    connectedCallback() {
            console.log('bhschbhcbha:' + this.defaultRecordId);
