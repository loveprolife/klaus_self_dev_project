...
export default class NewUploadFilesXLwc extends LightningNavigationElement {
    @api sizeOpen;
    @api recordItemId;
    lwcName = 'UploadFiles2Lwc';
    isShowSpinner;
    customLabel = {
        SpinnerAlt,
    ...
    get colClass() {
        if (this.col == 1) {
            ...
            return 'slds-grid slds-col slds-large-size_2-of-12 slds-medium-size_4-of-12 slds-size_6-of-12';
        }
    }
    ...
    attachProperty(item) {
        ...
        Object.defineProperties(item, {
            ...
            "style" : {
                get() {
                    return 'width: 100px; height:100px; min-width: 100px; min-height: 100px; cursor:pointer;';
            ...
            "spinnerStyle" : {
                get() {
                    let spinnerStyle = 'min-width: 100px; width: 100px;height: 100px; cursor: pointer; position: absolute; z-index: 999; background-color: #eee; opacity: 0.8; background-position: center; background-repeat: no-repeat;';
                    // let spinnerStyle = 'min-width: 100px; width: 100%;height: 100%; cursor: pointer; position: absolute; z-index: 999; background-color: #eee; opacity: 0.8; background-position: center; background-repeat: no-repeat;';
