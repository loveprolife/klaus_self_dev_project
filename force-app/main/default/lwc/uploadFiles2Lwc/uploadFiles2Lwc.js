...
export default class UploadFiles2Lwc extends LightningNavigationElement {
    ...
    get colClass() {
        if (this.col == 1) {
            ...
            return 'slds-grid slds-col slds-large-size_6-of-12 slds-medium-size_6-of-12 slds-size_12-of-12';
        }
    }
    ...
    connectedCallback() {
        console.log('ssssss' + this.cssStyle);
            ...
            "style" : {
                get() {
                    ...
                    if(_this.isMobile){
                        ...
                        return 'height: 200px; width: auto; object-fit: cover;';
                    }
                }
            },
            "spinnerClass" : {
