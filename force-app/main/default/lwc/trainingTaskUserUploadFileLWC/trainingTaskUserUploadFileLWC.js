 ...
 * @LastEditors: WFC
 * @LastEditTime: 2023-08-10 11:30:21
 * @Description: 
 * @FilePath: \Hitest_2022\force-app\main\default\lwc\trainingTaskUserUploadFileLWC\trainingTaskUserUploadFileLWC.js
 */
import { LightningElement, track, api } from 'lwc';
import saveFile from '@salesforce/apex/TrainingExaminationController.saveFile';
import {ShowToastEvent} from 'lightning/platformShowToastEvent';
import Training_Task_Cancel from '@salesforce/label/c.Training_Task_Cancel';

export default class TrainingTaskUserUploadFileLWC extends LightningElement {
    label = {
