...
export default class UploadFiles3Lwc extends LightningNavigationElement {

    @api sizeOpen;
    lwcName = 'UploadFiles3Lwc';
    isShowSpinner;
    customLabel = {
        SpinnerAlt,
    ...
    get colClass() {
        if (this.col == 1) {
            ...
            return 'slds-grid slds-col slds-large-size_2-of-12 slds-medium-size_2-of-12 slds-size_2-of-12';
        }
    }
        ...
        Object.defineProperties(item, {
            ...
            "style" : {
                get() {
                    ...
                    return 'height: 100px; width: auto; object-fit: cover;';
    ...
    handleDeleteFile(event) {
        ...
        const events = new CustomEvent('actionevent', { detail: { message: 'Do something' } });
    ...
    handleDeleteFile1(index) {
        ...
        const childComponent = this.template.querySelector('c-create-file-item-lwc');
        childComponent.updateIsSpecified(true);
        
        //this.parentTrigger();
        const events = new CustomEvent('checkevent', { detail: { message: 'Do something' } });
        this.dispatchEvent(events);
    ...
    performAction() {
        // 执行需要的操作
        console.log('Action performed by child component');
        this.parentTrigger();
    }
}