 ...
 * @LastEditors: WFC
 * @LastEditTime: 2024-06-20 15:36:53
 * @Description: 
 * @FilePath: \HisenseAll20240426\force-app\main\default\lwc\trainingTasksShowPictureLwc\trainingTasksShowPictureLwc.js
 */
...
// import getStatus from '@salesforce/apex/NewSamplingAndTicketController.getStatus';
...
export default class TrainingTasksShowPictureLwc extends LightningNavigationElement {
    ...
    // wiredResult
    // @wire(getStatus, { recordId: "$recordId"})  //赋值假数据
    // getStatus(result) {
