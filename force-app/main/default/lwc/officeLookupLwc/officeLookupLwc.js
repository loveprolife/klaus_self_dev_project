...
import getOfficeLookupData from "@salesforce/apex/LookupController.getOfficeLookupData";
...
export default class OfficeLookupLwc extends LightningElement {
	...
	connectedCallback() {
        console.log('XXXSalesRegion' + this.salesRegion );
		this.option = this.op;
